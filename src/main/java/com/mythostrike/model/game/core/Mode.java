...
public enum Mode {
    ...
    IDENTITY_FOR_FIVE(
        new Identity[] {Identity.GODKING, Identity.GENERAL, Identity.REBEL, Identity.REBEL, Identity.RENEGADE}),
    IDENTITY_FOR_EIGHT(
        new Identity[] {Identity.GODKING, Identity.GENERAL, Identity.GENERAL, Identity.REBEL, Identity.REBEL,
    ...
    THREE_VERSUS_THREE(
        new Identity[] {Identity.TEAMRED, Identity.TEAMRED, Identity.TEAMRED, Identity.TEAMBLUE, Identity.TEAMBLUE,
            Identity.TEAMBLUE}),
    FOUR_VERSUS_FOUR(
        new Identity[] {Identity.TEAMRED, Identity.TEAMRED, Identity.TEAMRED, Identity.TEAMRED, Identity.TEAMBLUE,
