...
import core.card.CardData;
import core.card.CardDeck;
import core.card.CardSpace;
...
public class GameManager {
    ...
    public void gameStart(){
        ...
        for (Player player: players) {
            game.output(player.getName()+ " as Seat " + players.indexOf(player) + " has "+player.getChampion().getName() + "with core.skill:");
    ...
    public void runPhases(){
        ...
        switch (phase) {
            ...
            case FINISH -> {
                /**
                 * finish do literally nothing except for core.skill invoke
                 */
